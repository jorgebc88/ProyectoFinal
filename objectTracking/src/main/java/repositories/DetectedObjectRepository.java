...
public interface DetectedObjectRepository extends
		JpaRepository<DetectedObject, Long> {

	// TODO: find out hot to format dates on SQL sentences to match
	// day/month/year
	...
	@Procedure(procedureName = "sp_createObject")
