...
app.service('objectService', ['$http', function ($http){
  ...
  var searchObjects = function(startDate, endDate) {
    return $http.get('http://192.168.2.120:8080/REST-API/detectedObject/requestDetectedObjectByDatesBetweenAndCameraId?startDate=' + startDate + '&endDate=' + endDate + '&cameraId=' + 1);
  };
